...
app.whenReady().then(async () => {
  ...
  const navigated = await win.webContents.executeJavaScript(
    `(function(){ var it=[].slice.call(document.querySelectorAll('.sb-item')).find(function(e){return /reports/i.test(e.textContent||'');}); if(it){ it.click(); return true; } return false; })()`);
